...
const addPresolicitud = async (req, res) => {
  try {
    const { descripcion, requerimientosHardware, requerimientosHardwareUser, requerimientosSoftware, tiempo, kiosco, empresa, idservices, idusuarios } = req.body
    ...
    const newPresolicitud = await Solicitud.create(
      { descripcion, requerimientosHardware, requerimientosHardwareUser, requerimientosSoftware, tiempo, kiosco, empresa, idservices, idusuarios }
    )
